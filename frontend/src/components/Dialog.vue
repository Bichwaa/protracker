<template>
    <div class="">
        <dialog ref="confirmationDialog" open class=" border-[#490A47] rounded-md drop-shadow-lg bg-[#e2e2e2] z-50">
            <div class="flex w-full flex-row-reverse px-6 pt-3">
